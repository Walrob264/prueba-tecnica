...
function FormCreateUser({
  ...
  const validationForm = async (product) => {
    ...
    if (product.Image === "")
      newErrors.imgUrl = "La URL de la imagen es obligatorio*";
      ...
      <div style={style.containtForm}>
        <Form style={style.form} className="container">
          <div style={style.headerForm}>
            <h2 style={style.tittleHeader}>
              {editForm ? "Editar" : "Crear nuevo producto"}
            </h2>
            <button
              type="button"
              className="btn-close"
          ...
          <Button
            ...
            onClick={editForm ? editProduct : createNewUser}
          >
